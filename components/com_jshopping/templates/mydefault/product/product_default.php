...
<div class="jshop productfull" id="comjshop">
        <div class="row">
            <div class="col-lg-10 col-md-9 col-sm-9 col-xs-10">
                ...
                <?php if (isset($this->product->product_old_price) && $this->product->product_old_price != null): ?>
                    <div class="sale_percent">
                        Скидка 
                        <?php
                            $percent = $this->product->product_old_price - $this->product->getPriceCalculate();
                            echo intval($percent * 100 / $this->product->product_old_price) . "%";
                        ?>
                    </div>
                <?php endif; ?>
            ...
            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-2 product_print">
                <i onclick="window.print();" class="fa fa-print" aria-hidden="true" title="Распечатать"><span>Распечатать</span></i>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <ul class="nav nav-tabs header_tabs_prod" role="tablist">
                    <li role="presentation" class="active"><a href="#descr" aria-controls="descr" role="tab" data-toggle="tab">Описание</a></li>
                    <li role="presentation"><a href="#prod_detail" aria-controls="prod_detail" role="tab" data-toggle="tab">Характеристики</a></li>
                    <li role="presentation"><a href="#prod_related" aria-controls="prod_related" role="tab" data-toggle="tab">Сопутствующие товары</a></li>
                    <li role="presentation">
                        <a href="#reviews" aria-controls="reviews" role="tab" data-toggle="tab">
                            Отзывы
                            <b><?php echo $product->reviews_count;?></b>
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                                ...
                                <span id='list_product_image_middle'>
                                    ...
                                    <?php foreach($this->images as $k=>$image){?>
                                        <a class="lightbox" id="main_image_full_<?php print $image->image_id?>" href="<?php print $this->image_product_path?>/<?php print $image->image_full;?>" <?php if ($k!=0){?>style="display:none"<?php }?> title="<?php print htmlspecialchars($image->_title)?>">
                                            ...
                                            <div class="text_zoom"><i class="fa fa-search-plus" aria-hidden="true"></i></div>
                                        </a>
                                    <?php }?>
                                </span>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="prod_detail">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="prod_related">
                        <?php        
                        ...
                        <?php if (!$this->hide_buy){?>                         
                            <div class="prod_buttons" style="<?php print $this->displaybuttons?>">
                                ...
                                <div class="prod_qty_input">
                                    <input type="text" name="quantity" id="quantity" onkeyup="reloadPrices();" class="inputbox" value="<?php print $this->default_count_product?>" /><?php print $this->_tmp_qty_unit;?>шт.
                                </div>
